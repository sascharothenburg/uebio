/* =====================================================================
   geld-pdf.js  ·  PDF-Modul für die Geld-App (pdf-lib)
   © 2026 Sascha Rothenburg

   Sachrechnen mit Geld als PDF mit absoluten Koordinaten ->
...
(function (global) {
  ...
  function drawHeader(ctx, opts) {
    ...
    ctx.text('Mit Geld rechnen', PT.marginX, top, { font: F.heavy, size: 14, color: C.blue });
  ...
  global.GeldPDF = { PT, GEO, buildWorksheetPDF };
